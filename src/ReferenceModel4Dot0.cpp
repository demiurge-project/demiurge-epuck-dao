...
CCI_EPuckProximitySensor::SReading ReferenceModel4Dot0::GetProximityReading() {
...
void ReferenceModel4Dot0::SetProximityInput(CCI_EPuckProximitySensor::TReadings s_prox_input) {
...
CCI_EPuckLightSensor::SReading ReferenceModel4Dot0::GetLightReading() {
...
void ReferenceModel4Dot0::SetLightInput(CCI_EPuckLightSensor::TReadings s_light_input) {
...
Real ReferenceModel4Dot0::GetGroundReading() {
...
CCI_EPuckOmnidirectionalCameraSensor::SReadings ReferenceModel4Dot0::GetCameraInput() const {
...
void ReferenceModel4Dot0::SetCameraInput(CCI_EPuckOmnidirectionalCameraSensor::SReadings s_cam_input) {
...
void ReferenceModel4Dot0::SetLEDsColor(const CColor& c_color) {
...
const CColor& ReferenceModel4Dot0::GetLEDsColor() const {
    return m_cLEDsColor;
}
...
void ReferenceModel4Dot0::SetGroundLEDsState(size_t b_state) {
...
size_t ReferenceModel4Dot0::GetGroundLEDsState() {
